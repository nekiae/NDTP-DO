...
# Компилированный regex для парсинга дат
...
SCHEDULE_KEYWORDS: List[str] = [
    ...
    "январ", "февраль", "март", "апрель", "май", "июн", "июл",
    "август", "сентябр", "октябр", "ноябр", "декабр",
]

DOCUMENT_KEYWORDS: List[str] = [
    "документ", "документы", "справк", "заявлен", "согласи",
    "свидетельство", "медицинск", "рождени", "бассейн", "инфекц",
    "план", "учебный", "при заезде", "поступлен", "регистрац",
    "что нужно", "что взять", "какие нужны", "список документов",
    "необходимые",
]
